...
class Senior extends Employee {
    constructor(name: string, age: number) {
        super(name, age);
        this.tasks.push(`${name} is working on a comlicated task.`);
        this.tasks.push(`${name} is taking time off work.`);
        this.tasks.push(`${name} is supervasing junior workers.`);
    }
}
...
class Manager extends Employee {
    ...
    constructor(name: string, age: number) {
        ...
        this.tasks.push(`${name} is preparing a quarterly meeting.`);
    }
